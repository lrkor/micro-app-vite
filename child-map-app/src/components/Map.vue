...
import geoJson from '../assets/map.js';
        ...
        const drawMap = () => {
            ...
            let option = {
                ...
                geo3D: {
                    show: true,
                    map: '安徽',
                    environment: echarts.graphic.LinearGradient(
                        0,
                        0,
                        0,
                        1,
                    ...
                    light: {
                        ...
                        main: {
                            ...
                            alpha: 100, // 主光源绕 x 轴，即上下旋转的角度。配合 beta 控制光源的方向。[ default: 40 ]
